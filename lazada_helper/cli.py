...
from .client import LazadaConfig
from .client import LazadaConfigError
from .finance import get_payout_status
from .finance import get_transaction_details
from .finance import query_account_transactions
from .finance import query_logistics_fee_detail
from .orders import build_default_order_window
from .orders import fetch_orders
from .orders import get_order_items
from .products import get_product_item
from .products import get_products
from .reviews import list_seller_reviews_v2
from .reviews import list_seller_reviews_history
from .reviews import add_seller_review_reply
from .returns_refunds import get_reverse_orders_for_seller
from .returns_refunds import list_return_detail
from .returns_refunds import list_return_history
from .returns_refunds import list_return_reasons
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    rr_reason_cmd = rr_subparsers.add_parser(
    ...
    review_list_v2_cmd.add_argument("--item-id", required=True)
    review_list_v2_cmd.add_argument("--id-list", default=None)
